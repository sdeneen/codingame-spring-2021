...
export default class Player {
  ...
  equals = (other: Player): boolean =>
    ...
    Object.keys(this.cellIndexToTree).length ===
      Object.keys(other.cellIndexToTree).length &&
    Object.keys(this.cellIndexToTree).every((key) =>
      other.cellIndexToTree[key].equals(this.cellIndexToTree[key])
    );
}
